...
<form method="post" action="<?php echo e(route('register-post')); ?>" style="padding-left: 15px;">
    <?php echo csrf_field(); ?>
    <div class="container">
    <div class="row">
        <div class="col-md-6">
...
<link rel="stylesheet" href="<?php echo e(asset('style_register.css')); ?>">
<style>
    .error {color: red;}
    .radio-label {
        margin-left: 5px;
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Christoper Lim\Herd\Facebook\resources\views/auth/register.blade.php ENDPATH**/ ?>